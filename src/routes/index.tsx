  ...
  return (
    <div class="flex flex-col gap-10 ">
      ...
      <div class="animate-fadeInDown delay-100">
        ...
        <div class="grid grid-cols-4 gap-2 items-center md:grid-cols-8">
