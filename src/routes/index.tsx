    ...
    <div class="flex flex-col gap-10">
      ...
      <div>
        ...
        <div class="flex flex-col gap-8">
          <Project title="LocalToMe" url="/projects/localtome" image="/localtome/LocalToMe1.png" text="LocalToMe is a web application that locates and provides low-income families/individuals with free & accessible food resources near their area within their budgets." tools="Next JS, React, Styled-components, Framer-motion, Material UI, Storybook, Firebase, Mapbox, Algolia" />
          <Project title="RainCheck" url="/projects/raincheck" image="/raincheck/RainChecks.png" text="RainCheck is an interactive map web application providing insights on the Vancouver housing market and lets you know how long it takes you to afford one. Created during BCIT’s QDS 2023 Hackathon." tools="Next JS, React, Styled-components, TailwindCSS, Framer-motion, React Leaflet, Axios, Chart Js" />
