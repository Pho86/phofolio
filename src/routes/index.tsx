...
export default component$(() => {
  return (
    <div class="flex flex-col gap-10 ">
      <div class="max-w-[75%] flex flex-col gap-5">
        <h1 class="text-5xl">
      ...
      <div>
        ...
        <div class="flex flex-col gap-8">
          <Project title="LocalToMe" url="/projects/localtome" image="/localtome/LocalToMe1.png" text="LocalToMe is a web application that locates and provides low-income families/individuals with free & accessible food resources near their area within their budgets." tools="Next JS, React, Styled-components, Framer-motion, Material UI, Storybook, Firebase, Mapbox, Algolia" giturl="https://github.com/phoenixlai833/localtome" liveurl="https://localtome.vercel.app/" align={true} />
