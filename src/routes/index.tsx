    ...
    <div class="flex flex-col gap-10 ">
      <div class="max-w-[75%] flex flex-col gap-5 animate-fadeInDown">
        ...
        <div class="animate-fadeInDown delay-75">
          <h2 class="font-medium">I am an aspiring Front-End Developer developing for web and mobile with a focus on providing users with the most seamless experience possible.</h2>
        </div>
      </div>
