...
* **Role:** Lead Developer
* **Tools used:** Next JS, React, Styled-components, Material UI
...
<img src="/sharefood/JSON.png" class="w-full" alt="1 of Share Food's JSON files that we made by hand."/>
  <figcaption>
    1 of Share Food's JSON files that we made by hand.
  </figcaption>
</figure>
</div>
...
<br/>
In the end, we were able to successfully build a fully functional web application and present our project to a room of over 75+ people.
