...
<div class="flex justify-evenly flex-col gap-5 md:flex-row md:gap-4 animate-fadeInDown">
   <Button text="Github Repo" url="https://github.com/Pho86/Genshinfy"/>
   <Button text="Live Site" url="https://genshinfy.vercel.app/"/>
</div>
</div>
<figure class="mt-0">
<img src="/genshinfy/Genshinfy.png" class="w-full h-full" alt="Where do I listen to music from Genshin Impact? At Genshinfy." loading="lazy"/>
  <figcaption>
...
<figure>
<img src="/genshinfy/Genshinfy3.png" alt="About Page for Genshinfy Music. Genshinfy is a music streaming web application." loading="lazy"/>
  <figcaption>
...
<figure>
<img src="/genshinfy/PiniaStore.png" alt="Pinia store that is saved throughout each page, as you change page it continuously plays." loading="lazy"/>
  <figcaption>
...
<figure>
<img src="/genshinfy/Favourites.png" alt="Genshinfy music favourites page" loading="lazy"/>
  <figcaption>
